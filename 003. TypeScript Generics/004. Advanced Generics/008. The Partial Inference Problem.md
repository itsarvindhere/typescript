...
This is what we call the Partial Inference Problem in TypeScript generics. This is still an issue in TypeScript and there is no way to solve it directly. However, there are some workarounds that we can use to mitigate this problem.
